...
自动添加HTML/XML关闭标签，就像Visual Studio IDE或Sublime Text所做的一样。
...
此包用于与Visual Studio代码编辑器一起使用，并在编辑器的状态栏中显示焦点文件的大小。
...
一个Visual Studio代码扩展，它为HTML类属性提供CSS类名补全，基于在工作空间中找到的定义或通过link元素引用的外部文件。
...
> 这个扩展包含Vs代码编辑器的ES6语法中的JavaScript代码片段(支持JavaScript和TypeScript)。
>
> `JavaScript`代码片段
...
3. [支持一键添加佛祖保佑永无BUG、神兽护体等注释图案](https://github.com/OBKoro1/koro1FileHeader/wiki/佛祖保佑永无BUG、神兽护体、注释图案)
...
> 文档内的方法如果失效了，自己Google一下。就解决了，如果我自己使用文档方法无法激活才会更新。
