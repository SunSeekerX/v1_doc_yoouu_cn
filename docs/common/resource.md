...
[Emoji符号表情大全](https://www.5vmc.com/emoji/emoji.html)
...
[xxfpm](https://github.com/78/xxfpm) - 跨平台FastCGI进程管理器，可用作php的进程管理。
...
[Nodejs-Roadmap](https://github.com/Q-Angelo/Nodejs-Roadmap) - 【Nodejs-Roadmap】侧重于 Node.js 服务端的开发指南，公众号 “Nodejs技术栈” [https://www.nodejs.red](https://www.nodejs.red/)
...
[resume](https://github.com/Blankj/resume) - android开发人员的简历模板。
...
[localForage](https://github.com/localForage/localForage) - 💾离线存储,提高。使用简单但功能强大的API包装IndexedDB、WebSQL或localStorage。
...
[MyUtils](https://github.com/XmanLin/MyUtils) - 常用的JavaScript工具函数
